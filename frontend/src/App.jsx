...
export default function App() {
  ...
  return <div className="app">
    ...
    <main><section className="intro"><div><p className="eyebrow">DCA-3701 · UFRN</p><h2>Lugar Geométrico das Raízes</h2><p>Explore a resolução completa de forma visual e interativa.</p></div><div className="status"><span className="dot" /> API conectada</div></section><div className="layout"><ParameterPanel form={form} loading={loading} exporting={exporting} canExport={Boolean(data)} error={error} onChange={update} onCalculate={calculate} onExport={exportPdf} /><section className="results">{data ? <AnalysisSummary data={data} /> : <div className="empty"><Activity size={42} /><h3>Pronto para analisar</h3><p>Informe os parâmetros e clique em calcular para visualizar a resolução.</p></div>}</section></div></main>
